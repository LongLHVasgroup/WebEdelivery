...
{
    public partial class TEST_eDeliveryContext : DbContext
    {
        public TEST_eDeliveryContext()
        {
        }

        public TEST_eDeliveryContext(DbContextOptions<TEST_eDeliveryContext> options)
            : base(options)
        {
        }
