...
{
    public partial class Vas_3000Context : DbContext
    {
        public Vas_3000Context()
        {
        }

        public Vas_3000Context(DbContextOptions<Vas_3000Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(Config.getInstance().connPMC3000);
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CheckingScrapModel>(entity =>
            {
                ...
                entity.Property(e => e.StartCheckingTime).HasColumnType("datetime");
            ...
            modelBuilder.Entity<VehicleRegisterMobileModel>(entity =>
            {
                ...
                entity.Property(e => e.TapChat).HasColumnType("decimal(38, 0)");

                entity.Property(e => e.ThoiGianToiDuKien).HasColumnType("datetime");

                entity.Property(e => e.ThoiGianToiThucTe).HasColumnType("datetime");

                entity.Property(e => e.TrongLuongGiaoDuKien).HasColumnType("decimal(38, 0)");

                entity.Property(e => e.TrongLuongGiaoThucTe).HasColumnType("decimal(38, 0)");
            ...
            modelBuilder.Entity<VehicleRegisterPodetailModel>(entity =>
            {
                ...
                entity.Property(e => e.TiLe).HasColumnType("decimal(38, 0)");

                entity.Property(e => e.TrongLuong).HasColumnType("decimal(38, 0)");
